...
GraphBuilder.prototype.addSummary = function() {
    ...
    return $.get(
        GraphBuilder.dataPath + 'summary.txt', function(data) {
            $(container).html(data);
        }
    );
}
...
GraphBuilder.prototype.drawUserCounts = function() {
    ...
    $.get(
        GraphBuilder.dataPath + 'userCounts.txt', function(data) {
            try {
                ...
                google.visualization.events.addListener(
                    regVis, 'ready', function() {
                        check.isDone();
                    }
                );
                google.visualization.events.addListener(
                    actVis, 'ready', function() { 
                        check.isDone();
                    }
                );
...
GraphBuilder.prototype.drawEditCounts = function() {
    ...
    $.get(
        GraphBuilder.dataPath + 'editCounts.txt', function(data) {
            try {
...
GraphBuilder.prototype.drawWebserviceCounts = function() {
    ...
    $.get(
        GraphBuilder.dataPath + 'webservice.txt', function(data) {
            try {
...
GraphBuilder.prototype.drawEditFrequencies = function() {
    ...
    $.get(
        GraphBuilder.dataPath + 'usageFrequencies.txt.edits', function(data) {
            try {
...
GraphBuilder.prototype.drawViewFrequencies = function() {
    ...
    $.get(
        GraphBuilder.dataPath + 'usageFrequencies.txt.views', function(data) {
            try {
...
GraphBuilder.prototype.drawXrefFrequencies = function() {
    ...
    $.get(
        GraphBuilder.dataPath + 'contentFrequencies.txt.xrefs', function(data) {
            try {
                if(that.slowBrowser()) {
                    that.browserNotice(cont);
                    dfd.reject();
...
GraphBuilder.prototype.drawLitFrequencies = function() {
    ...
    $.get(
        GraphBuilder.dataPath + 'contentFrequencies.txt.lit', function(data) {
            try {
                if(that.slowBrowser()) {
                    that.browserNotice(cont);
                    dfd.reject();
...
GraphBuilder.prototype.drawIntFrequencies = function() {
    ...
    $.get(
        GraphBuilder.dataPath + 'contentFrequencies.txt.int', function(data) {
            try {
                if(that.slowBrowser()) {
                    that.browserNotice(cont);
                    dfd.reject();
...
GraphBuilder.prototype.drawUserFrequencies = function() {
    ...
    $.get(
        GraphBuilder.dataPath + 'userFrequencies.txt', function(data) {
            try {
...
GraphBuilder.prototype.drawPathwayCounts = function() {
    ...
    $.get(
        GraphBuilder.dataPath + 'pathwayCounts.txt', function(data) {
            try {
                var vis = null;
                var opt = null;
...
GraphBuilder.prototype.drawCollectionCounts = function() {
    ...
    $.get(
        GraphBuilder.dataPath + 'collectionCounts.txt', function(data) {
            try {
...
GraphBuilder.prototype.drawUniquePerSpecies = function() {
    ...
    if(graphCont) {
        $.get(
            GraphBuilder.dataPath + 'uniquePerSpecies.txt', function(data) {
                try {
    ...
    if(tblCont) {
        $.get(
            GraphBuilder.dataPath + 'uniquePerSpecies.txt.titles', function(data) {
                try {
